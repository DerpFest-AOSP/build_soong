...
var (
	...
	DataBindingDepClassInfoPath              = "prebuilts/lmodroid/libraries/current/data-binding/class-info"
	DataBindingDepArtifactsPath              = "prebuilts/lmodroid/libraries/current/data-binding/artifacts"
